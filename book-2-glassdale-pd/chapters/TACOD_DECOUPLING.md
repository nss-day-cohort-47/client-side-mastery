...
In the next chapter you will try this out with the Technically Averse Coding Offenses Department application you are building. In the previous chapter, you built a dropdown element that lists evidence. You will have that component dispatch a custom message to an Event Hub, and the instructor list component will listen for that event and then behave how it chooses.
